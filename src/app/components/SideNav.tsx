...
import { Home, Package, ShoppingCart, Store, Video, MessageSquare, Users, DollarSign, Truck, FileText, Settings, ChevronDown, Crown, Megaphone } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export function SideNav({
  ...
  const getNavKey = (label: string): string => {
    const keyMap: Record<string, string> = {
      ...
      'Plans': 'nav.subscriptionPlans',
      'Subscribers': 'nav.subscriptionSubscribers',
  ...
  const navItems: NavItem[] = [
    ...
    { icon: Store, label: "Vendor", badge: badgeCounts?.vendor || 0 },
