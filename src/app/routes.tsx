        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              { path: "logistics/new", element: <AdminSubdomainLeaf /> },
              { path: "logistics/:partnerSlug", element: <AdminSubdomainLeaf /> },
              { path: "logistics/:partnerSlug/edit", element: <AdminSubdomainLeaf /> },
